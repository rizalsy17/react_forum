import {
  ...
  export const createComment = (token, threadId, content) => {
    return async (dispatch) => {
      try {
        const response = await createCommentApi(token, threadId, content);
  ...
  export const upVoteComment = (token, threadId, commentId) => {
    return async (dispatch) => {
      try {
        const response = await upVoteCommentApi(token, threadId, commentId);
  ...
  export const downVoteComment = (token, threadId, commentId) => {
    return async (dispatch) => {
      try {
        const response = await downVoteCommentApi(token, threadId, commentId);
  ...
  export const neutralizeCommentVote = (token, threadId, commentId) => {
    return async (dispatch) => {
      try {
        const response = await neutralizeCommentVoteApi(token, threadId, commentId);
